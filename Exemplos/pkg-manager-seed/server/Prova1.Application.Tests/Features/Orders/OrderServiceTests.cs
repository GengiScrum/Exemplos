...
namespace Prova1.Application.Tests.Features.Orders
{
    ...
    public class OrderServiceTests : TestServiceBase
    {
        ...
        public void Orders_Service_Delete_ShouldBeOk()
        {
            ...
            _orderRepositoryFake.Setup(odr => odr.Remove(orderCmd.OrderIds.First())).Returns(mockIsRemoved);
            //Action
            var isOrderRemoved = _service.Remove(orderCmd);
            //Assert
            _orderRepositoryFake.Verify(odr => odr.Remove(orderCmd.OrderIds.First()), Times.Once);
        ...
        public void Orders_Service_Delete_ShouldBeHandleNotFoundException()
        {
            ...
            var orderCmd = ObjectMother.GetOrderValidToRemove();
            var exception = new NotFoundException();
            _orderRepositoryFake.Setup(odr => odr.Remove(orderCmd.OrderIds.First())).Throws(exception);
            //Action
        ...
        [Test]
        public void Orders_Service_Delete_ShouldBeHandleNotRemoved()
        {
            //Arrange
            var orderCmd = ObjectMother.GetOrderValidToRemove();
