import { IPizzaPrice } from './pizza.model';
import { Topping, PizzaSizes } from './pizza.enum';

export class Toppings {
  public static readonly ALL_TOPPINGS: Topping[] = [Topping.Anchovu, Topping.Bacon,
  Topping.Basil, Topping.Chili, Topping.Mozzarella, Topping.Mushroom,
  Topping.Olive, Topping.Onion, Topping.Pepper, Topping.Pepperoni, Topping.Sweetcorn, Topping.Tomato];
}
...
export class Pizza {
  ...
  public static calculateTotalSet(pizzas: Pizza[]): number {
    const price: number = pizzas.reduce((prev: number, next: Pizza) => {
